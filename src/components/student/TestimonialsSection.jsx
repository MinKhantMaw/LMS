  ...
  return (
    <div className="pb-14 px-8 md:px-0 ">
      ...
      <p className="md:text-base text-gray-500 mt-3">
        ...
        est sapiente <br /> eveniet quas eum fugit ratione porro sed iusto.
      </p>
      <div className="grid grid-cols-3 gap-8 mt-14 px-20">
        {dummyTestimonial.map((testimonial, index) => (
          ...
          >
            ...
            <a href="#" className="text-blue-500 underline px-5 py-3">
              Read more
            </a>
          </div>
        ))}
